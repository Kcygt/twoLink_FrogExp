%%% WEBSITE: https://uk.mathworks.com/matlabcentral/fileexchange/71456-b-spline-approximation
% close all
% XY = [0	0;
%       1 1;
%       2 -3;
...
% h=plot(XY(:,1),XY(:,2),'-o',BS2(1:6:28,1),BS2(1:6:28,2),BS3(1:6:28,1),BS3(1:6:28,2),'-*');
