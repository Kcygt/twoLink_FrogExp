...
% Parameters
time = 10;  % Time
wn = [1      4      5 ];  % Prefilter Omega     
kj = [ 200            50      140.3188];  % Spring constants
bj = [10  40 18.29829 ];  % Damping constants
wt = [2000, 0, .01];  % Weights [qDes, Time, qMid]
...
ub = [10   10 10 10      40 40 40   300 300 300];  
