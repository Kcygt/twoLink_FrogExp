...
wt = [10, 0, 50];  % Weights [qDes, Time, qMid]
...
ub = [10   10 10 10 40 40 40   100 100 100  3 3 3  ];  
...
function error = objectiveFunction(params, qDes, wt, qMid)
    ...
    disp(['Current objective value: ', num2str(error)]);
    % pause(0.1);
end
...
% kj = [50 50 50];       % Spring constants
% bj = [30 30 30];       % Damping constants
% wt = [1, 1e-4, 100];  % Weights [qDes, Time, qMid]
% 
% % Optimization setup
